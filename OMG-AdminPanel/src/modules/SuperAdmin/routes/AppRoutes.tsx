...
import KYCApproval from "../components/Client/KYCApproval";
...
import Project from "../components/PlotMaster/Project/Project.js";
import Sector from "../components/PlotMaster/Sector/Sector.js";
import Block from "../components/PlotMaster/Block/Block.js";
import Segment from "../components/PlotMaster/Segment/Segment.js";
import PlotType from "../components/PlotMaster/PlotType/PlotType.js";
import PlotNumber from "../components/PlotMaster/PlotNumber/PlotNumber.js";
import EMIMaster from "../components/PlotMaster/EMIMaster/EMIMaster.js";
import AvailablePlots from "../components/PlotBookingReports/AvailablePlots/AvailablePlots.js";
import BookedPlots from "../components/PlotBookingReports/BookedPlots/BookedPlots.js";
import CancelledPlot from "../components/PlotBookingReports/CancelledPlots/CancelledPlot.js";

import TopEarners from "../components/Reports/TopEarners.js";
import WalletReport from "../components/Reports/WalletReport.js";
import BookNewPlat from "../components/BookPlot/BookNewPlot/BookNewPlat.jsx";
import PayEMI from "../components/BookPlot/PayEMI/PayEMI.js";
import PlotDetails from "../components/BookPlot/PlotDetails/PlotDetails.js";
import MemberPaymentVerification from "../components/MemberPaymentVerification/MemberPaymentVerification.jsx";
        ...
        <div className="main-content flex flex-col overflow-hidden min-h-screen transition-all">
          ...
          <Routes>
            <Route element={<ProtectedRoute />}>
              ...
              />
              <Route
                path="/superadmin/plot-master/manage-project"
                element={<Project />}
              />
              <Route
                path="/superadmin/plot-master/sector"
                element={<Sector />}
              />
              <Route path="/superadmin/plot-master/block" element={<Block />} />
              <Route
                path="/superadmin/plot-master/segment"
                element={<Segment />}
              />
              <Route
                path="/superadmin/plot-master/plot-type"
                element={<PlotType />}
              />
              <Route
                path="/superadmin/plot-master/plot-number"
                element={<PlotNumber />}
              />
              <Route
                path="/superadmin/plot-master/emi-master"
                element={<EMIMaster />}
              />
              // plot booking reports
              <Route
                path="/superadmin/plot-booking-reports/available-plots"
                element={<AvailablePlots />}
              />
              <Route
                path="/superadmin/plot-booking-reports/Cancelled-plots"
                element={<CancelledPlot />}
              />
              <Route
                path="/superadmin/plot-booking-reports/booked-plots"
                booked-plots
                element={<BookedPlots />}
              />
              <Route
              ...
              />
              <Route
                path="/superadmin/client/kyc-approval"
                element={<KYCApproval />}
              />
              <Route
              ...
              />
              <Route
                path="/superadmin/new-book-plot/book-plot"
                element={<BookNewPlat />}
              />
              <Route
                path="/superadmin/new-book-plot/pay-emi"
                element={<PayEMI />}
              />
              <Route
                path="/superadmin/new-book-plot/plot-details"
                element={<PlotDetails />}
              />
              <Route
                path="/superadmin/new-book-plot/member-payment-verification"
                element={<MemberPaymentVerification />}
              />
              //Withdrawal
              <Route
