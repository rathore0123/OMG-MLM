...
const Template: React.FC = () => {
  ...
  const procedure = "PlotCancelationReport";
  const pageTitle = "Cancelled Plot Report";
  const title = "Cancelled Plot";
    ...
    try {
      ...
      bg-white border border-gray-200 shadow-xl rounded-xl p-2 pointer-events-none"
              ...
              if (c.ColumnKey == "PlotStatus") {
                return (
                  <span className="bg-red-400 text-white p-2 py-1 font-bold rounded-2xl">
                    Booked
                  </span>
                );
              }
              ...
              if (typeof value === "string" && value.includes("<")) {
                return (
                  <span
                    className="bg-green-400 text-white p-1 rounded-2xl"
