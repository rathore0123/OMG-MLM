...
const Template: React.FC = () => {
  ...
  const procedure = "SectorMaster";
  const pageTitle = "Manage Sector";
  const title = "Sector";
  ...
  const handleImageUpload = async (
    ...
    fd.append("pagename", "RealStateSectors");
  ...
  const fetchGridColumns = async () => {
    ...
    try {
        ...
        const reactCols = data
          ...
          .map((c: any, colIndex: number) => ({
            ...
            cell: (row: any) => {
              ...
              if (c.ColumnKey === "SectorImage") {
                return (
                  <div className="relative group inline-block">
                    <a
                      className="text-blue-500 underline"
                      href={`${import.meta.env.VITE_IMAGE_PREVIEW_URL_2}RealState/Sectors/${value}`}
                      target="_blank"
                      rel="noreferrer"
                    >
                      View
      ...
      bg-white border border-gray-200 shadow-xl rounded-xl p-2 pointer-events-none"
                    >
                      <img
                        src={`${import.meta.env.VITE_IMAGE_PREVIEW_URL_2}RealState/Sectors/${value}`}
                        alt="Preview"
            ...
            <div className="relative w-full sm:w-[180px]">
              ...
              >
                ...
                >
                  ...
                  <option value="SectorName">Sector Name</option>
                </select>
                    ...
                    onSubmit={async (values, { resetForm }) => {
                      ...
                      const payload = {
                        ...
                        Para: JSON.stringify({
                          ...
                          SectorId: editData?.SectorId || 0,
                          ProjectId: values.projectId,
                          SectorName: values.sectorName,
                          SectorImage: values.fileName,
                          EditId: editData?.SectorId || 0,
                        }),
                      };
                      ...
                      try {
                        ...
                        if (res[0]?.Status == 1) {
                          await Swal.fire({
                            ...
                            text: res[0]?.Msg || "Sector saved successfully",
                            timer: 1500,
                            showConfirmButton: false,
                          });
                          resetForm();
    ...
    transition-all focus:border-primary-button-bg"
      ...
      focus:border-primary-button-bg"
                        ...
                        <div className="space-y-2">
                          ...
                          {/* Image Preview */}
                          {(values.file || editData?.SectorImage) && (
                            <div className="mt-3 w-full rounded-md overflow-hidden border border-gray-200 dark:border-[#172036] bg-gray-50 dark:bg-[#0c1427]">
                              ...
                              <div className="flex items-center justify-center p-3 h-[200px]">
                                {values.file ? (
                                  ...
                                  <img
                                    src={`${import.meta.env.VITE_IMAGE_PREVIEW_URL_2}RealState/Sectors/${editData.SectorImage}`}
                                    alt="Existing Banner"
                                    className="max-h-full max-w-full object-contain rounded"
                                  />
                                ) : null}
                              ...
                              {editData?.SectorImage && !values.file && (
                                <div className="flex justify-end px-3 py-2 border-t border-gray-200 dark:border-[#172036]">
                                  <a
                                    href={`${import.meta.env.VITE_IMAGE_PREVIEW_URL_2}RealState/Sectors/${editData.SectorImage}`}
                                    target="_blank"
                                    rel="noreferrer"
