...
const Template: React.FC = () => {
  const formSchema = Yup.object().shape({
    ...
    segmentName: Yup.string().required("Segment is required"),
  });
  ...
  const procedure = "SegmentMaster";
  const pageTitle = "Manage Segment";
  const title = "Segment";
            ...
            <div className="relative w-full sm:w-[180px]">
              ...
              >
                ...
                >
                  ...
                  <option value="ProjectName">Segment Name</option>
                </select>
                ...
                {editLoading ? (
                  ...
                  <Formik
                    ...
                    initialValues={{
                      ...
                      segmentName: editData?.SegmentName || "",
                    }}
