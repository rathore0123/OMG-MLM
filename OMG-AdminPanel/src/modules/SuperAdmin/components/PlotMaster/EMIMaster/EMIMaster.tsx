...
const Template: React.FC = () => {
  const formSchema = Yup.object().shape({
    ...
    type: Yup.string().required("EMI Type is required"),
    duration: Yup.string().required("Duration is required"),
    salePrice: Yup.number().required("Plot Rate is required"),
    discount: Yup.number(),
  });
  ...
  const procedure = "EMIMaster";
  const pageTitle = "Manage EMI";
  const title = "EMI";
  ...
  rounded-lg overflow-hidden"
      ...
      dark:border-[#172036] bg-white dark:bg-[#0c1427] px-[17px] block w-full outline-0"
                          >
                            ...
                            <option value="M">Monthly EMI</option>
                            <option value="CDP">Cash Down Payment</option>
                            <option value="EMI+CDP">
                              EMI With Cash Down Payment
                            </option>
                          </Field>
