...
import { AddFundINRReport } from "../../../utils/Constant";
...
const Template: React.FC = () => {
  ...
  const procedureName = "AddFundINRReport";
  const pageTitle = AddFundINRReport;
  const landingPageTitle = "Add Fund INR Report";
  const breadCrumbs = {
    parent: "Deposit",
    child: "Add Fund INR Report",
  };
