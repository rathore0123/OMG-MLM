...
import { PayoutTitle, UplineIncome } from "../../../utils/Constant";
...
const UplineIncomeComponent = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={UplineIncome}
        parent={PayoutTitle}
        ChildName={UplineIncome}
      />
      <Container fluid>
...
export default UplineIncomeComponent;
