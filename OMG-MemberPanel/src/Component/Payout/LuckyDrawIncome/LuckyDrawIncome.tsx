...
import { PayoutTitle, LuckyDrawIncome } from "../../../utils/Constant";
...
const LuckyDrawIncomeComponent = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={LuckyDrawIncome}
        parent={PayoutTitle}
        ChildName={LuckyDrawIncome}
      />
      <Container fluid>
...
export default LuckyDrawIncomeComponent;
