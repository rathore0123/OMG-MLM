...
import { PayoutTitle, DailySalary } from "../../../utils/Constant";
...
const DailySalaryComponent = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={DailySalary}
        parent={PayoutTitle}
        ChildName={DailySalary}
      />
      <Container fluid>
...
export default DailySalaryComponent;
