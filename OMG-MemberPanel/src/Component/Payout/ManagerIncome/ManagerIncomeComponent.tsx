...
import { PayoutTitle, ManagerIncome } from "../../../utils/Constant";
...
const ManagerIncomeComponent = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={ManagerIncome}
        parent={PayoutTitle}
        ChildName={ManagerIncome}
      />
      <Container fluid>
...
export default ManagerIncomeComponent;
