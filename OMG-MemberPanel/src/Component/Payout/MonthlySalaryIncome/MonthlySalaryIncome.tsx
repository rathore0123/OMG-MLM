...
import { PayoutTitle, MonthlySalaryIncome } from "../../../utils/Constant";
...
const MonthlySalaryIncomeComponent = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={MonthlySalaryIncome}
        parent={PayoutTitle}
        ChildName={MonthlySalaryIncome}
      />
      <Container fluid>
...
export default MonthlySalaryIncomeComponent;
