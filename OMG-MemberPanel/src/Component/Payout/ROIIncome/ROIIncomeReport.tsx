...
import { BinaryIncomeReport, RoiIncomeReport } from "../../../utils/Constant";
...
const Template: React.FC = () => {
  ...
  //centralised values
  const procedureName = "GetMemberROIIncomeReport";
  const pageTitle = RoiIncomeReport;
  const landingPageTitle = "ROI Income";
  const breadCrumbs = {
            ...
            ──────────────────────────────────────────────────────────────── */}
                ...
                <div className="filter-dropdown">
                  ...
                  >
                    ...
                    <option value="ProductName">Package Name</option>
                  </select>
                </div>
