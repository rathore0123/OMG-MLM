...
import { PayoutTitle, FirstActivationBonus } from "../../../utils/Constant";
...
const FirstActivationBonusPage = () => {
  ...
  return (
    <>
      <Breadcrumbs
        mainTitle={FirstActivationBonus}
        parent={PayoutTitle}
        ChildName={FirstActivationBonus}
      />
      <Container fluid>
...
export default FirstActivationBonusPage;
