...
import { ReferralIncomeReport } from "../../../utils/Constant";
...
const Template: React.FC = () => {
  ...
  const pageTitle = ReferralIncomeReport;
  const landingPageTitle = "Referral Income";
  const breadCrumbs = {
    parent: "Payout Income",
    child: "Referral Income",
  };
  ...
  const statsConfig = [
    ...
    {
      key: "InactiveReferrals",
      title: "Inactive Referrals",
      sub: "Inactive Referrals",
