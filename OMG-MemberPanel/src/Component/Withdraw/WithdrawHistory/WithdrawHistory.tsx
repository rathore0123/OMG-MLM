...
import { RoiIncomeReport, WithdrawalReport } from "../../../utils/Constant";
...
const Template: React.FC = () => {
  ...
  //centralised values
  const procedureName = "WithdrawFundReport";
  const pageTitle = WithdrawalReport;
  const landingPageTitle = "Withdrawal Report";
  const breadCrumbs = {
    parent: "Withdraw",
    child: "Withdraw Report",
  };
