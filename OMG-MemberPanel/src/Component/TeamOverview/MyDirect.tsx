...
const Template: React.FC = () => {
  ...
  //centralised values
  const procedureName = "MyDirectsReport";
  const pageTitle = MyDirect;
  const landingPageTitle = "My Direct Team";
  const breadCrumbs = {
    parent: "Team",
    child: "My Direct (Team)",
  };
  ...
  const statsConfig = [
    ...
    {
      key: "ThisMonthDirects",
      title: "This Month Directs",
      showCurrency: false,
      sub: "This Month Directs",
      color: "var(--btn-bg), #4cc9f0",
      icon: "✅",
    },
    {
      key: "LastMonthDirects",
      title: "Last Month Directs",
      showCurrency: false,
      sub: "Last Month Directs",
      color: "var(--btn-bg), #7209b7",
      icon: "📋",
    },
  ];
